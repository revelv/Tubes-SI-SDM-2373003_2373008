...
--
-- Host: localhost:3306
-- Generation Time: Jun 16, 2025 at 02:10 PM
...
CREATE TABLE `employee_skills` (
  ...
  `tingkat_keahlian` enum('pemula','menengah','mahir','ahli') COLLATE utf8mb4_general_ci NOT NULL,
...
(2, 8, 1, 'pemula', 'test pem', '2025-06-16 13:36:04'),
(3, 8, 2, 'ahli', 'test ahli', '2025-06-16 13:36:11');
...
CREATE TABLE `skills` (
  `id` int NOT NULL,
  `nama_skill` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `jenis_skill` enum('soft_skill','hard_skill') COLLATE utf8mb4_general_ci NOT NULL,
